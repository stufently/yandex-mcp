...
- [ ] Деструктивные тулы Вебмастера (`delete-host`) и ставки в Директе — без dry-run и
      подтверждения. `delete-counter` в Метрике закрыт `confirm: true` 2026-08-21; сделать
      то же самое (или dry-run) в остальных пакетах
