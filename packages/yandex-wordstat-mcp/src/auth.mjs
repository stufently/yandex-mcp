...
export async function runAuth() {
  ...
  const authorizeUrl = `https://oauth.yandex.com/authorize?response_type=code&client_id=${clientId}`;
  ...
  console.error('Set this as YANDEX_WORDSTAT_TOKEN environment variable.');
}
